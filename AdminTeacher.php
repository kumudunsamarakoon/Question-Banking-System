                            		...
                            		<div class="col-lg-10">
                            		    <table class = "table table-bordered">
                                		    ...
                                		    <tbody>
                                                ...
                                                ?>
                                    		    <tr>
                                        		    <td><?php echo $data['tea_nic']; ?></td>
                                        		    <td><?php echo $data['tea_fName']." ".$data['tea_lName'];?></td>
                                        		    <td><?php echo $data['tea_email']; ?></td>
                                        		    <td><?php echo $data['tea_telephone'];?></td>
                                                    <td><?php echo $data['tea_bank'];?></td>
                                                    <td><?php echo $data['tea_accNo'];?></td>
                                                     <td> <a href="AdminTeaUploadPapers.php?tid=<?php echo $data['tea_nic'] ?>" class = 'btn btn-prime'  >Uploaded papers</a> </td>
                                    		    </tr>
